...
def lab3Zadanie2():
    ...
    tols = (10.0 ** (-1.0), 10.0 ** (-4.0), 10.0 ** (-6.0))
    files = ("Zadanie2.txt", "Zadanie2.1.txt", "Zadanie2.2.txt")
    for file, tol in zip(files, tols):
        ru = iterateEquasion(RK2Eauasion, function1Zad2, function2Zad2, start, end, 0.01, S, x0, v0, tol)
        with open(file, "w") as fp:
            for u1 in ru:
                fp.write(
                    "{0.x:0.20f} {0.v:0.20f} {0.e:0.20f} {0.dt:0.20f} {0.t:0.20f} {0.X2:0.20f} {0.V2:0.20f}\n".format(
                        u1))
...
def lab3Zadanie1():
    dt = 0.05;
    ran1 = drange(0.0, 10.0, dt)
    ran2 = drange(0.0, 10.0, 2.0 * dt)
    euera1 = iterate(simpleEuera, functionZad1, ran1, dt, -1.0)
    rk1 = iterate(RK2, functionZad1, ran1, dt, -1.0)
    ...
    euera2 = richardson(simpleEuera, functionZad1, ran2, 2.0 * dt, -1.0)
    rk2 = richardson(RK2, functionZad1, ran2, 2.0 * dt, -1.0)
